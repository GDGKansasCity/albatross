...
/**
 * @ngdoc filter
 * @name albatrossApp.filter:hashLinky
 * @function
 * @description
 * # hashLinky
 * Filter in the albatrossApp.
      ...
      for (i = 0; i < startNode.childNodes.length; i++) {
        ...
        switch (currentNode.nodeType) {
          ...
          case TEXT_NODE:
            ...
            currentNode.textContent =  currentNode.textContent.replace(hashtagRegex, '<a href="https://plus.google.com/s/%23$1" target="_blank">#$1</a>');
